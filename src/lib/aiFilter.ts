 ...
 */
export async function filterCancerResources(resources: Resource[]): Promise<Resource[]> {
  try {
    ...
    for (const r of resources) {
      const ok = await isCancerRelated(r, apiKey);
