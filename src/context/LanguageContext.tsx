...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'trials.hub_title': 'Clinical Trials Hub',
    'trials.hub_subtitle': 'Search trials and explore community discussions and videos.',
    'trials.tab': 'Trials',
    'community.tab': 'Community',
    'videos.tab': 'Videos',
    'trials.search_placeholder': 'Search clinical trials (e.g., breast cancer)',
    'trials.location_placeholder': 'Location (optional)',
    'trials.search': 'Search',
    'trials.status': 'Status',
    'trials.conditions': 'Conditions',
    'trials.view_on_ctgov': 'View on ClinicalTrials.gov',
    'shared.loading': 'Loading...',
    'shared.error': 'Something went wrong',
    'shared.no_results': 'No results found',
    'community.api_key_placeholder': 'Enter Firecrawl API key',
    'community.save_key': 'Save Key',
    'community.query_placeholder': 'Topic to fetch (e.g., immunotherapy side effects)',
    'community.fetch': 'Fetch posts',
  },
  es: {
